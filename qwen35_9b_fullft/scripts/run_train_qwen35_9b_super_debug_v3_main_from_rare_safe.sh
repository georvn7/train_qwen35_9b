...
START_FULL_MODEL="${START_FULL_MODEL:-$WORK/qwen35_9b_fullft/runs/20260506_045018_qwen35_9b_rare_actions_sft_from_round2_dpo_841_32k_v1/artifacts/full_model}"
DATASET_ROOT="${DATASET_ROOT:-$WORK/qwen35_9b_fullft/data/super-debug-v3-no-assistant-thinking.jsonl}"
MODEL_DISPLAY_NAME="${MODEL_DISPLAY_NAME:-hayabusa-qwen-9b}"
LABEL="${LABEL:-hayabusa-qwen-9b_v3_main_sft_2611_from_rare_32k_v1}"
...
SESSION_NOTES="${SESSION_NOTES:-hayabusa-qwen-9b: Qwen3.5-9B continuation SFT on super-debug-v3 no-assistant-thinking main dataset, starting from latest rare-actions full model.}"
...
if [[ ! -f "$DATASET_ROOT" ]]; then
  echo "ERROR: super-debug-v3 main SFT dataset not found: $DATASET_ROOT" >&2
  exit 1
fi
